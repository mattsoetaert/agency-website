      ...
      <main className="min-h-screen bg-[#f5f4f0]">
        ...
        <section className="pt-32 pb-10 px-4 sm:px-6 border-b border-black/8">
          <div className="max-w-3xl mx-auto">
            <Link
              href="/articles"
              className="inline-flex items-center gap-1.5 text-xs font-semibold uppercase tracking-[0.18em] text-neutral-400 hover:text-black transition-colors mb-8"
            >
        ...
        <section className="px-4 sm:px-6 pb-24">
          <div className="max-w-3xl mx-auto">
            <div className="bg-black text-white p-8 sm:p-10">
              ...
              <p className="text-neutral-400 text-sm leading-relaxed mb-6 max-w-lg">
              ...
              <a
                href="/#contact"
                className="inline-block px-6 py-3 bg-white text-black font-semibold text-sm hover:bg-neutral-100 transition-colors"
              >
                Book a Free Call
              </a>
            </div>
